...
public class NextSnappingKeybind extends CustomKeybind{

    public NextSnappingKeybind() {
        super("snapping_next", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_ADD, KeybindCategory.IN_GAME_EDITOR);
    }
